...
import Hero from '../../src/assets/Images/Home/Group 276.png';
      ...
      <div className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Robot Image - Right Side with Wave Animation */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button 
                      ...
                      className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition duration-300 flex items-center hover:shadow-lg hover:shadow-purple-500/25"
                    >
                      Add to Cart
